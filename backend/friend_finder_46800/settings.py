"""
Django settings for friend_finder_46800 project.
...
ROOT_URLCONF = 'friend_finder_46800.urls'
...
WSGI_APPLICATION = 'friend_finder_46800.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "friend_finder_46800 API",
    "DESCRIPTION": "API documentation for friend_finder_46800 App",
    "VERSION": "v1",
}
